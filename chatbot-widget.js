...
function startConversation() {
    fetch('https://chatbot-for-kids-r-kids-new-territory-samuelsicking.replit.app/start', {
        method: 'GET'
    })
    .then(response => response.json())
    .then(data => {
...
document.getElementById('chat-form').addEventListener('submit', function(event) {
   ...
   // sendInputToGAS3(userMessage, true);
    ...
    fetch('https://chatbot-for-kids-r-kids-new-territory-samuelsicking.replit.app/chat', {
        method: 'POST',
        headers: {
...
function sendToGas4(message, isUserMessage) {
    ...
    const GAS_URL4 = 'https://script.google.com/macros/s/AKfycbx3XkKwYpf8AIG5fRs6mAyX0IeMKg0Dve59dnwhPNgS5lHYsHKWUz_El9Q6rh2UFeOYBg/exec';
